...
class DiscriminatorR(nn.Module):
    def __init__(self, cfg: AttrDict, resolution: List[List[int]], device):
        super().__init__()
...
class MultiResolutionDiscriminator(nn.Module):
    def __init__(self, cfg, device, debug=False):
        super().__init__()
        ...
        self.discriminators = nn.ModuleList(
            [DiscriminatorR(cfg, resolution, device) for resolution in self.resolutions]
        )
